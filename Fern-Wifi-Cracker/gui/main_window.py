...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.scan_button_label = QtWidgets.QLabel(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scan_button_label.sizePolicy().hasHeightForWidth())
        self.scan_button_label.setSizePolicy(sizePolicy)
        self.scan_button_label.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(font_setting)
        self.scan_button_label.setFont(font)
        self.scan_button_label.setObjectName(_fromUtf8("scan_button_label"))
        self.verticalLayout.addWidget(self.scan_button_label)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.scan_button_label.setText(QtWidgets.QApplication.translate("Dialog", "Scan for Access points", None, 0))
